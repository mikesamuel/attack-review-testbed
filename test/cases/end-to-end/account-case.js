  ...
  requests: (baseUrl) => [
    {
      ...
      res: {
        body: [
          ...
          '<head>',
          '<title>Login</title>',
          '<script src="/common.js" nonce="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx3">',
          '</script>',
    ...
    },
    {
      ...
      res: {
        body: [
          ...
          '<script src="/common.js" nonce="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx8">',
          '</script>',
    ...
    },
    {
      ...
      res: {
        body: [
          ...
          '<head>',
          '<title>Edit Account</title>',
          '<script src="/common.js" nonce="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx9">',
          '</script>',
          '<link rel="stylesheet" href="/styles.css" nonce="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx9">',
          '</head>',
          '<body>',
          '<div class="userfloat">',
          '<span class="user name">',
