...
// See ./lockdown.js for guarantees re process.

// The guarantees re Function are mostly checked by the flag choice in
// main, but the guarantee below states captures the negative space
// around what the Function masking below aims to allow.

// GUARANTEE - A module that doesn't explicitly invoke Function(...) or
// new Function(...) shouldn't be able to implicitly load code as in
//    // Attacker controlled strings
//    let a = 'constructor', b = 'console.log(1337)';
//    // Naive code
//    ({})[a][a](b)();
// so we don't need to audit all modules for possible implicit access to
