...
CREATE TABLE IF NOT EXISTS PostResources (
...
VALUES
  ( x'Ada'::int,  true,   '2019-04-05 12:00:00', 'Hi!  My name is <b>Ada</b>.  Nice to meet you!' ),
  ( x'B0b'::int,  true,   '2019-04-06 12:00:00', '</div></span></table></div>Ada, <script>alert("Hi!")</script>!' ),
  ( x'Deb'::int,  true,   '2019-04-07 12:00:00', '<b>&iexcl;Hi, all!</b>' ),
  ( x'Deb'::int,  false,  '2019-04-08 12:00:00', 'Bob, I''m browsing via Lynx and your post isn''t Lynx-friendly.' ),
  ( x'Fae'::int,  true,   '2019-04-09 12:00:00', 'Sigh!  Yet another Facebook.com knockoff without any users.' ),
  ( x'Fae'::int,  true,   '2019-04-10 12:00:00', '(It is probably insecure)' ),
  ( x'B0b'::int,  false,  '2019-04-11 12:00:00', 'You think?' )
;
